...
type Project struct {
	...
	BuildOutputDir string `yaml:"build-output-dir"`
	...
	DistOutputDir string `yaml:"dist-output-dir"`
	...
	DistScriptInclude string `yaml:"dist-script-include"`
...
type Product struct {
	...
	DefaultPublish Publish `yaml:"publish"`
}
...
type Dist struct {
	...
	// generated binaries.
	InputProducts []string `yaml:"input-products"`
	...
	DistType DistInfo `yaml:"dist-type"`
...
type BinDist struct {
	...
	OmitInitSh *bool `yaml:"omit-init-sh"`
	...
	InitShTemplateFile string `yaml:"init-sh-template-file"`
}
...
type SLSDist struct {
	...
	YMLValidationExclude matcher.NamesPathsCfg `yaml:"yml-validation-exclude"`
}
...
type DockerImage struct {
	...
	Deps            []DockerDep     `yaml:"dependencies"`
	Info            DockerImageInfo `yaml:"info"`
	BuildArgsScript string          `yaml:"build-args-script"`
}
...
type SLSDockerImageInfo struct {
	...
	GroupID      string                 `yaml:"group-id"`
	ProuductType string                 `yaml:"product-type"`
	Extensions   map[string]interface{} `yaml:"manifest-extensions"`
}
