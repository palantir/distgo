...
import (
	...
	"github.com/palantir/distgo/dockerbuilder/buildxdockerbuilder"
	v0 "github.com/palantir/distgo/dockerbuilder/buildxdockerbuilder/config/internal/v0"
)
...
func (cfg *Default) ToDockerBuilder() distgo.DockerBuilder {
	...
	return &buildxdockerbuilder.BuildxDockerBuilder{
